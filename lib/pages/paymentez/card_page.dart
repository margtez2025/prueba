...
import 'package:credit_card_type_detector/models.dart' as cr;
  ...
  Widget _crearNumero() {
    return TextFormField(
      onChanged: (String str) {
        ...
        if (mounted) setState(() {});
        List<cr.CreditCardType> cardTypes = cr.detectCCType(str);

        IconData ccBrandIcon = FontAwesomeIcons.creditCard; // Default icon
        if (cardTypes.isNotEmpty) {
          cr.CreditCardType brand = cardTypes.first;
          ...
          } else if (brand == cr.CreditCardType.jcb()) {
