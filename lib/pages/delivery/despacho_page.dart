...
class DespachoPageState extends State<DespachoPage>
  ...
  _notificar(String identificacion) async {
    try {
      String url =
          'https://api.whatsapp.com/send?phone=59171470802&text=Hola, mi identificación es: $identificacion. ';
          ...
          Visibility(
              ...
              child: Positioned(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    String url =
                        'https://api.whatsapp.com/send?phone=${despachoModel.telSuc.toString().replaceAll('+', '')}&text=Hola desde ${Sistema.aplicativoTitle} revisar los detalles de un pedido de: ${cajeroModel.detalle}';
                    final Uri _url = Uri.parse(url);
