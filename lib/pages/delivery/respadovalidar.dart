...
//       // Usa el token de App Check obtenido previamente
//       String tokenAppCheck = _tokenService.token;

//     if (currentUser?.phoneNumber == cliente.celular.toString()) {
//       print('verificationCompleted for current');
//       _clienteProvider.validadCelular(cliente.celular, tokenAppCheck);
//       prefs.solicitados = 0;
//       accionConfirmacion();
//       return;
//     }
...
//   void _validarVerificarCelular() async {
//     if (_presBerificar) return;

//         // Obtén el token de App Check manualmente
//     await _tokenService.obtenerTokenManualmente(); // Obtén el token de App Check manualmente
...
//       }
//       _formKey.currentState.save();
//       _clienteProvider.verificarValidadCelular(cliente.celular.toString(), _tokenService.token,
//           (estado, error) {
//         if (estado == 1) {
...
// //   final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
// //   final ClienteProvider _clienteProvider = ClienteProvider();
// //   final TokenService _tokenService = TokenService(); // Instancia de TokenService
...
// //     try {
// //       await _tokenService.obtenerTokenManualmente();
// //       setState(() {});
// //     } catch (e) {
// //       dlg.mostrar(context, 'Error al obtener el token de App Check.', mIzquierda: 'ACEPTAR');
// //     }
// //   }
// //   @override
// //   Widget build(BuildContext context) {
...
// //     // Verificar que el token de App Check esté disponible
// //     if (_tokenService.token == 'Token aún no obtenido' || _tokenService.token == 'Token no disponible') {
// //       await obtenerTokenManualmente(); // Intentar obtener el token manualmente si no está disponible
// //     }

// //     if (_tokenService.token == 'Token no disponible') {
// //       dlg.mostrar(context, 'No se puede verificar el teléfono sin un token válido.', mIzquierda: 'ACEPTAR');
// //       return;
// //     }
...
// //       // Verificar que el token de App Check esté disponible
// //   if (_tokenService.token == 'Token aún no obtenido' || _tokenService.token == 'Token no disponible') {
// //      obtenerTokenManualmente(); // Intentar obtener el token manualmente si no está disponible
// //   }
...
// //         await obtenerTokenManualmente(); // Llama a obtenerTokenManualmente para actualizar el token
// //       String token = _tokenService.token; // Obtiene el token actualizado desde TokenService

// //       _clienteProvider.verificarValidadCelular(
// //         cliente.celular.toString(),    
// //         token, // Pasa el token como argumento en lugar de la función obtenerTokenManualmente
// //         (estado, error) {
// //           if (estado == 1) {
// //             // Verificamos si el celular no ha sido verificado
// //             _verifyPhoneNumber();
// //           } else if (estado == 0) {
// //             // Cuando el número ya fue verificado
// //             _clienteProvider.validadCelular(cliente.celular);
// //             prefs.solicitados = 0;
// //             accionConfirmacion();
// //           } else {
...
// // // void _verifyPhoneNumber() async { 
// // //   if (_eventToken == 'Token aún no obtenido' || _eventToken == 'Token no disponible') {
// // //     print('Error: Token de App Check no está disponible');
// // //     dlg.mostrar(context, 'No se puede verificar el teléfono sin un token válido.', mIzquierda: 'ACEPTAR');
// // //     return;
// // //   }
...
// // //     print('verificationFailed');
// // //     print(authException.message);
// // //     String mensaje = 'Hemos bloqueado todas las solicitudes de este dispositivo debido a una actividad inusual. Intentá nuevamente más tarde.';
// // //     dlg.mostrar(context, mensaje, mIzquierda: 'ACEPTAR');
// // //   };
...
// // //             if (_eventToken == 'Token no disponible') {
// // //               dlg.mostrar(context, 'No se pudo obtener el token de App Check.', mIzquierda: 'ACEPTAR');
// // //               return;
// // //             }
...
// // //         } else {
// // //           mensaje = 'El código de verificación\nes incorrecto.';
// // //         }
...
// // // // Verifica que _eventToken no esté vacío antes de llamar a la función
// // //     if (_eventToken == 'Token aún no obtenido' || _eventToken.isEmpty) {
// // //       // Intentar obtener el token manualmente si no está disponible
// // //       await obtenerTokenManualmente();
// // //     }
...
// // //         cliente.celular.toString(),    
// // //         _eventToken,     
// // //         (estado, error) { // Usa el token actualizado automáticamente
// // //       if (estado == 1) {
// // //         _verifyPhoneNumber();
// // //          } else if (estado == 0) {
// // //               _clienteProvider.validadCelular(cliente.celular);
