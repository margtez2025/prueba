...
class _CatalogoPageState extends State<CatalogoPage>
    ...
    final card = Container(
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 3.0),
            Expanded(  // Aquí usa Expanded o Flexible
              child: Container(
                width: 50.0,
                height: 46.0,
                ...
                child: Container(
                  child: cache.fadeImage(categoriaModel.img, width: 30, height: 30),
  ...
  _icono(int element) {
    return BottomNavigationBar(
      ...
      //selectedItemColor: Color.fromARGB(210, 100, 75, 240), // color naranja para iconos en general  
      selectedItemColor: Color.fromARGB(255, 255, 115, 0), // color naranja para iconos en general  
      onTap: _onItemTapped,
    );
  }
