...
//   // Obtén el token de App Check manualmente antes de proceder
//   String appCheckToken;
//   try {
//     appCheckToken = await FirebaseAppCheck.instance.getToken(true);
//     print('Token de App Check obtenido manualmente: $appCheckToken');
//   } catch (e) {
...
//     _saving = false;
//     if (mounted) setState(() {});
//     dlg.mostrar(context, 'Error: Token de App Check no disponible.', mIzquierda: 'ACEPTAR');
//     return;
//   }

//   // Resto del código para iniciar la verificación del número de teléfono
...
// if (_eventToken != 'Token aún no obtenido' && _eventToken.isNotEmpty) {
//   _clienteProvider.verificarValidadCelular(
//     cliente.celular.toString(),
//     _eventToken, // Usa el token actualizado automáticamente
//     (estado, error) {
//       if (estado == 1) {
//         _verifyPhoneNumber();
//       } else if (estado == 0) {
...
//   );
// } else {
//   print('Token de App Check aún no disponible');
//   dlg.mostrar(context, 'Token de seguridad no disponible. Intenta de nuevo.', mIzquierda: 'ACEPTAR');
// }
