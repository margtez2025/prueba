...
// ojo aqui yo cambie esto
_verNumero() async {
  var permissionPhone = await Permission.phone.status;
  ...
  if (permissionPhone.isGranted) {
    try {
      ...
      print("Error al obtener el número de teléfono: $exception");
    }
  } else {
    print("Permiso de teléfono no concedido.");
  }
}
