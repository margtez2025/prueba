...
class _VentasPageState extends State<VentasPage> {
  ...
  _confirmarConvertirDespachador() {
    ...
    dlg.mostrar(context,
        'Presione ACEPTAR solo si esta seguro de querer convertir al usuario ${_cliente.nombres} en un Despachado RANTY y haya recibido el pago previo acordado.',
  ...
  _confirmarComprarPaquete(TarjetaModel tarjetaModel) {
    ...
    dlg.mostrar(
        context,
        'Confirmo recibir: \n\n${(_recibo).toStringAsFixed(2)} Bs.\n\n'
        'Crédito a consumir: \n\n$_creditoAconsumir Bs.\n\n'
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              suffixIcon: IconButton(
                ...
                onPressed: () async {
                  dlg.mostrar(context,
                      'Con RANTY Money puedes pagar el costo o parte del costo de entrega. \n\nAl invitar a tus amigos a usar RANTY tienes mayor probabilidad de obtener money.',
                      titulo: 'RANTY Money');
                },
              ),
              hintText: 'RANTY Money',
              labelText: 'RANTY Money',
              icon: prs.iconoMoney),
        ),
      ),
    );
