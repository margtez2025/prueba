...
const String colorSecondary = '#0067CE'; //Purpura
get colorAppBar => hexToColor('#FF7700');
...
get colorLineBorder => hexToColor('#DDDDBD');
...
get iconoDespachando => Icon(FontAwesomeIcons.rocket, color: Color.fromARGB(255, 200, 106, 6));
...
get iconoDesActivo => Icon(FontAwesomeIcons.userSlash, color: Color.fromARGB(255, 178, 15, 3));

get iconoChatActivo => Icon(FontAwesomeIcons.commentsDollar, color: Color.fromARGB(255, 28, 168, 33));
